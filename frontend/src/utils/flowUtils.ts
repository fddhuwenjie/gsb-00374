...
export const nodeTypeColors: Record<NodeType, { bg: string; border: string; text: string }> = {
  ...
  file_write: { bg: '#14b8a6', border: '#0d9488', text: '#ffffff' },
  approval: { bg: '#a855f7', border: '#9333ea', text: '#ffffff' },
...
export const nodeTypeDescriptions: Record<NodeType, string> = {
  ...
  file_write: 'Write content to a file (idempotent)',
  approval: 'Pause for human approval with expirable token',

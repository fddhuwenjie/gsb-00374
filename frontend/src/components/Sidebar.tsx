...
import { Play, Square, GitBranch, RotateCcw, Clock, CircleDot, CircleOff, Globe, Database, FileText, Zap, Boxes, Shield, ShieldQuestion } from 'lucide-react';
...
const nodeTypes: NodeType[] = ['start', 'end', 'task', 'condition', 'loop', 'wait', 'http', 'sql', 'file_write', 'approval', 'parallel', 'subflow', 'trycatch'];
